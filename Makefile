...
# yylloc is defined in both dtc-lexer and dtc-parser (needs -fcommon on gcc >= 10 hosts)
HOSTCFLAGS  += $(shell $(HOSTCC) -fcommon -E -x c /dev/null >/dev/null 2>&1 && echo -fcommon)
