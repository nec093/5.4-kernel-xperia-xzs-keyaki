...
void wake_up_new_task(struct task_struct *p)
{
	...
	activate_task(rq, p, ENQUEUE_NOCLOCK | ENQUEUE_WAKEUP_NEW);
	p->on_rq = TASK_ON_RQ_QUEUED;
...
/* Implemented in topology.c: needs access to the static init_sched_groups_capacity() */
extern void sched_update_group_capacities(int cpu);
