...
/*
 * CAF: publish the (rate, voltage) pairs of a clock with a vdd_class as
 * OPPs of the devices listed in the provider node's
 * "qcom,<clk>-opp-handle" property (e.g. gfx3d_clk_src_v2 -> kgsl-3d0,
 * whose GPMU voltage table is built from them). Ported from 4.9.
 */
