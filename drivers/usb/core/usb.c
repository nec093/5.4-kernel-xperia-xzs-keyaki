...
/*
 * CAF additions (not in mainline): re-added from pristine mainline
 * (drivers/usb/core/usb.c), needed by drivers/net/usb/usbnet.c and a
 * couple of wireless USB drivers.
 */
