...
/*
 * CAF addition for msm8916/msm8996-style clk-smd-rpm.c and clk-voter.c
 * (a different, non-QCOM_SMD_RPM_-prefixed naming scheme than the
 * RPM_SMD_* block above, which is what those two drivers actually
 * reference). Appended rather than merged into the block above since
 * upstream never unified the two naming schemes.
 */
