...
struct usb_function {
	const char			*name;
	int				intf_id;	/* CAF addition, not in mainline. */
...
struct usb_configuration {
	...
	/*
	 * CAF addition (not in mainline): number of in and out eps used in
	 * this configuration.
	 */
	int			num_ineps_used;
	int			num_outeps_used;
...
struct usb_function_instance {
	...
	/* CAF addition (not in mainline): back-pointer to the currently
	 * attached function, if any. */
