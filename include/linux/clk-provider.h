...
#define CLK_IGNORE_UNUSED	BIT(3) /* do not gate even if unused */
				/* unused */
/* CAF addition (not in mainline): mainline itself once had this flag at
 * this same bit position (later removed, leaving it marked "unused"
 * above), so this is not a re-numbering, just restoring the original
 * value. */
