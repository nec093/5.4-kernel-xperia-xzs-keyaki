...
/*
 * CAF addition (not in mainline): skb_insert() was removed upstream as
 * apparently unused in-tree; restored (verbatim from port-4.14) since
 * drivers/net/ppp/{pppopns,pppolac}.c still call it directly.
 */
